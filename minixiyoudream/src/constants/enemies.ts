...
import type { EnemyTemplate, EnemyGroup, Enemy, EnemySkill } from '@/types';
import { generateUUID } from '@/types';
import { random, randomInt } from '@/utils/prng';

/** 通用敌人技能定义 */
const ENEMY_BASIC_SKILLS: Record<string, EnemySkill> = {
  bite: {
    id: 'enemy_bite',
    name: '撕咬',
    type: 'active',
  ...
  venom_bite: {
    ...
    cooldown: 0,
    multiplier: 0.8,
    effect: { type: 'debuff', statusEffect: 'poison', duration: 2 },
  },
  charge: {
    id: 'enemy_charge',
    name: '冲撞',
  ...
  web_shot: {
    ...
    cooldown: 2,
    multiplier: 0.6,
    effect: { type: 'debuff', stat: 'speed', value: -20, duration: 2 },
  },
  ghost_touch: {
  ...
  fire_breath: {
    ...
    multiplier: 1.2,
    element: 'fire',
    effect: { type: 'debuff', statusEffect: 'burn', duration: 2 },
  },
  sonic_screech: {
...
export const ENEMY_TEMPLATES: Record<string, EnemyTemplate> = {
  ...
  enemy_rabbit: {
    ...
    elementResistances: { metal: -20, wood: 20, water: 0, fire: 0, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.bite],
    aiBehavior: 'balanced',
    rarity: 'common',
  ...
  enemy_wolf: {
    ...
    elementResistances: { metal: 20, wood: 0, water: 0, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.claw],
  ...
  enemy_snake: {
    ...
    elementResistances: { metal: -20, wood: 20, water: 0, fire: 0, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.venom_bite],
    aiBehavior: 'aggressive',
    rarity: 'common',
  ...
  enemy_boar: {
    ...
    elementResistances: { metal: 0, wood: -20, water: 0, fire: 0, earth: 20 },
    skills: [ENEMY_BASIC_SKILLS.charge],
  ...
  enemy_frog: {
    ...
    elementResistances: { metal: 0, wood: 0, water: 20, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.venom_bite],
    aiBehavior: 'balanced',
    rarity: 'common',
  ...
  enemy_monkey_king: {
    ...
    elementResistances: { metal: 40, wood: 20, water: 20, fire: 0, earth: 20 },
    skills: [ENEMY_BASIC_SKILLS.claw],
    aiBehavior: 'aggressive',
    rarity: 'legendary',
  ...
  enemy_spider_small: {
    ...
    elementResistances: { metal: 0, wood: 0, water: 20, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.web_shot],
    aiBehavior: 'aggressive',
    rarity: 'common',
  ...
  enemy_spider_poison: {
    ...
    elementResistances: { metal: 0, wood: 0, water: 20, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.venom_bite, ENEMY_BASIC_SKILLS.web_shot],
    aiBehavior: 'aggressive',
    rarity: 'common',
  ...
  enemy_ghost: {
    ...
    elementResistances: { metal: 0, wood: 0, water: 20, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.ghost_touch],
    aiBehavior: 'balanced',
    rarity: 'common',
  ...
  enemy_water_demon: {
    ...
    elementResistances: { metal: 0, wood: 0, water: 20, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.water_jet],
    aiBehavior: 'balanced',
    rarity: 'common',
  ...
  enemy_bandit_elite: {
    ...
    elementResistances: { metal: 20, wood: 0, water: 0, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.claw, ENEMY_BASIC_SKILLS.charge],
    aiBehavior: 'aggressive',
    rarity: 'rare',
  ...
  enemy_fox_illusion: {
    ...
    elementResistances: { metal: 15, wood: 15, water: -5, fire: 25, earth: 15 },
    skills: [ENEMY_BASIC_SKILLS.ghost_touch],
    aiBehavior: 'balanced',
    rarity: 'rare',
  ...
  enemy_fairy_beast: {
    ...
    elementResistances: { metal: 0, wood: 30, water: 20, fire: 0, earth: 20 },
    skills: [ENEMY_BASIC_SKILLS.bite],
    aiBehavior: 'balanced',
    rarity: 'rare',
  ...
  boss_spider_queen: {
    ...
    elementResistances: { metal: 0, wood: 0, water: 30, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.venom_bite, ENEMY_BASIC_SKILLS.web_shot],
    aiBehavior: 'aggressive',
    rarity: 'legendary',
  ...
  boss_nine_tailed_fox: {
    ...
    elementResistances: { metal: 30, wood: 30, water: 10, fire: 40, earth: 30 },
    skills: [ENEMY_BASIC_SKILLS.ghost_touch],
    aiBehavior: 'balanced',
    rarity: 'legendary',
  ...
  enemy_boss_ghost: {
    ...
    elementResistances: { metal: 20, wood: 0, water: 20, fire: 20, earth: 30 },
    skills: [ENEMY_BASIC_SKILLS.ghost_touch],
    aiBehavior: 'aggressive',
    rarity: 'epic',
  ...
  boss_demon_king: {
    ...
    elementResistances: { metal: 30, wood: 50, water: 30, fire: 60, earth: 50 },
    skills: [ENEMY_BASIC_SKILLS.fire_breath, ENEMY_BASIC_SKILLS.ghost_touch],
    aiBehavior: 'balanced',
    rarity: 'legendary',
  ...
  boss_dragon_king: {
    ...
    elementResistances: { metal: 30, wood: 0, water: 50, fire: -20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.water_jet],
    aiBehavior: 'balanced',
    rarity: 'legendary',
  ...
  enemy_crab_spirit: {
    ...
    elementResistances: { metal: 0, wood: 0, water: 25, fire: -15, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.claw],
    aiBehavior: 'aggressive',
    rarity: 'rare',
  ...
  enemy_snake_demon: {
    ...
    elementResistances: { metal: -10, wood: 30, water: 0, fire: 0, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.venom_bite],
    aiBehavior: 'aggressive',
    rarity: 'legendary',
    levelRange: { min: 12, max: 12 },
  ...
  enemy_fox_demon_female: {
    ...
    elementResistances: { metal: 0, wood: 20, water: 0, fire: 30, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.ghost_touch],
    aiBehavior: 'balanced',
    rarity: 'legendary',
  ...
  enemy_qingfeng_daoshi: {
    ...
    elementResistances: { metal: 20, wood: 40, water: 30, fire: 20, earth: 30 },
    skills: [ENEMY_BASIC_SKILLS.ghost_touch],
    aiBehavior: 'balanced',
    rarity: 'legendary',
  ...
  enemy_red_blood_dragon: {
    ...
    elementResistances: { metal: 20, wood: 0, water: -20, fire: 40, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.fire_breath, ENEMY_BASIC_SKILLS.water_jet],
    aiBehavior: 'aggressive',
    rarity: 'legendary',
  ...
  enemy_terracotta_warriors: {
    ...
    elementResistances: { metal: 0, wood: -20, water: 0, fire: 20, earth: 30 },
    skills: [ENEMY_BASIC_SKILLS.claw],
    aiBehavior: 'defensive',
    rarity: 'rare',
  ...
  // 东海湾可捕捉宠物
  enemy_pet_sea_turtle: {
    id: 'enemy_pet_sea_turtle',
    name: '大海龟',
    ...
    expReward: 25,
    goldReward: 11,
    drops: [{ itemId: 'item_turtle_shell', rate: 0.2, minCount: 1, maxCount: 1 }],
    capturable: true,
    petTemplateId: 'pet_sea_turtle',
  },

  enemy_pet_giant_frog: {
    id: 'enemy_pet_giant_frog',
    name: '巨蛙',
    ...
    expReward: 22,
    goldReward: 11,
    drops: [{ itemId: 'item_frog_skin', rate: 0.15, minCount: 1, maxCount: 1 }],
    capturable: true,
    petTemplateId: 'pet_giant_frog',
  },

  enemy_pet_sea_worm: {
    id: 'enemy_pet_sea_worm',
    name: '海毛虫',
    ...
    expReward: 20,
    goldReward: 11,
    drops: [{ itemId: 'item_worm_jelly', rate: 0.2, minCount: 1, maxCount: 1 }],
    capturable: true,
    petTemplateId: 'pet_sea_worm',
  },

  // 江南野外可捕捉宠物
  enemy_pet_tree_monster: {
    id: 'enemy_pet_tree_monster',
    name: '树怪',
    ...
    expReward: 35,
    goldReward: 20,
    drops: [{ itemId: 'item_tree_bark', rate: 0.2, minCount: 1, maxCount: 1 }],
    capturable: true,
    petTemplateId: 'pet_tree_monster',
  },

  enemy_pet_wild_boar: {
    id: 'enemy_pet_wild_boar',
    name: '野猪',
    ...
    expReward: 40,
    goldReward: 20,
    drops: [{ itemId: 'item_tusk', rate: 0.15, minCount: 1, maxCount: 1 }],
    capturable: true,
    petTemplateId: 'pet_wild_boar',
  },
  ...
  enemy_pet_bandit: {
    ...
    drops: [
      { itemId: 'item_bandit_badge', rate: 0.15, minCount: 1, maxCount: 1 },
      { itemId: 'item_gold', rate: 0.25, minCount: 1, maxCount: 3 },
    ],
    capturable: true,
    petTemplateId: 'pet_bandit',
  },
  ...
  enemy_pet_bat: {
    ...
    expReward: 38,
    goldReward: 23,
    drops: [{ itemId: 'item_bat_wing', rate: 0.25, minCount: 1, maxCount: 1 }],
    capturable: true,
    petTemplateId: 'pet_bat',
  },

  enemy_pet_mountain_bandit: {
    id: 'enemy_pet_mountain_bandit',
    name: '山贼',
    ...
    goldReward: 30,
    drops: [
      { itemId: 'item_bandit_badge', rate: 0.2, minCount: 1, maxCount: 1 },
      { itemId: 'item_gold', rate: 0.3, minCount: 2, maxCount: 4 },
    ],
    capturable: true,
    petTemplateId: 'pet_mountain_bandit',
  },

  enemy_pet_goat_head: {
    id: 'enemy_pet_goat_head',
    name: '羊头怪',
    ...
    elementResistances: { metal: 0, wood: 0, water: -20, fire: 20, earth: 0 },
    skills: [ENEMY_BASIC_SKILLS.fire_breath],
    aiBehavior: 'balanced',
    rarity: 'common',
    levelRange: { min: 8, max: 15 },
    expReward: 50,
    goldReward: 30,
    drops: [{ itemId: 'item_goat_horn', rate: 0.15, minCount: 1, maxCount: 1 }],
    capturable: true,
    petTemplateId: 'pet_goat_head',
  },

  // 大雁塔可捕捉宠物
  enemy_pet_skeleton: {
    id: 'enemy_pet_skeleton',
    name: '骷髅',
    ...
    expReward: 60,
    goldReward: 81,
    drops: [{ itemId: 'item_bone', rate: 0.25, minCount: 1, maxCount: 2 }],
    capturable: true,
    petTemplateId: 'pet_skeleton',
  },
  ...
  enemy_pet_black_bear: {
    id: 'enemy_pet_black_bear',
    name: '黑熊',
    ...
    goldReward: 244,
    drops: [
      { itemId: 'item_bear_fur', rate: 0.2, minCount: 1, maxCount: 1 },
      { itemId: 'item_bear_gall', rate: 0.1, minCount: 1, maxCount: 1 },
    ],
    capturable: true,
    petTemplateId: 'pet_black_bear',
  },
};
...
export function createEnemy(templateId: string, level: number): Enemy | null {
  ...
  return {
    ...
    level,
    stats: {
      physicalAttack: Math.floor((template.baseStats.physicalAttack ?? 0) * levelFactor),
      physicalDefense: Math.floor((template.baseStats.physicalDefense ?? 0) * levelFactor),
      magicAttack: Math.floor((template.baseStats.magicAttack ?? 0) * levelFactor),
      magicDefense: Math.floor((template.baseStats.magicDefense ?? 0) * levelFactor),
      speed: Math.floor((template.baseStats.speed ?? 0) * levelFactor),
      maxHp: Math.floor((template.baseStats.maxHp ?? 0) * levelFactor),
      maxMp: Math.floor((template.baseStats.maxMp ?? 0) * levelFactor),
      critRate: template.baseStats.critRate ?? 0,
      critDamage: template.baseStats.critDamage ?? 0,
      hitRate: template.baseStats.hitRate ?? 0,
      dodgeRate: template.baseStats.dodgeRate ?? 0,
      antiCritRate: template.baseStats.antiCritRate ?? 0,
      penetration: template.baseStats.penetration ?? 0,
      lifeSteal: template.baseStats.lifeSteal ?? 0,
      reflect: template.baseStats.reflect ?? 0,
      healBonus: template.baseStats.healBonus ?? 0,
      cooldownReduction: template.baseStats.cooldownReduction ?? 0,
    },
    elementResistances: { ...template.elementResistances },
    element: template.element,
    skills: [...template.skills],
    hp: Math.floor((template.baseStats.maxHp ?? 0) * levelFactor),
    maxHp: Math.floor((template.baseStats.maxHp ?? 0) * levelFactor),
    mp: Math.floor((template.baseStats.maxMp ?? 0) * levelFactor),
    maxMp: Math.floor((template.baseStats.maxMp ?? 0) * levelFactor),
    statusEffects: [],
